...
public enum QuerySQL {
    ...
    MYSQL("mysql", "show tables", "show table status",
            ...
            "NAME", "COMMENT", "FIELD", "TYPE", "COMMENT", "KEY","EXTRA"),
    ;
    ...
    QuerySQL(final String dbType, final String tablesSql, final String tableCommentsSql,
             ...
             final String fieldType, final String fieldComment, final String fieldKey,final String fieldExt) {
        this.dbType = dbType;
