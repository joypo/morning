 ...
 */
package com.example.id.generator.impl;

import com.example.id.generator.buffer.BufferPaddingExecutor;
import com.example.id.generator.buffer.RejectedPutBufferHandler;
import com.example.id.generator.buffer.RejectedTakeBufferHandler;
import com.example.id.generator.buffer.RingBuffer;
import com.example.id.generator.config.UidProperties;
import com.example.id.generator.exception.UidGenerateException;
