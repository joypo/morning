...
@Getter
@AllArgsConstructor
public enum GlobalErrorEnum implements ResultCode {
    /**
     *
     */
    ...
    SEND_EMAIL_SUCCESS("019", "邮件已发送，请注意查收"),
    EDIT_PWD_SUCCESS("020", "修改密码成功"),
    No_FileSELECT("021", "未选择文件"),
    FILEUPLOAD_SUCCESS("022", "上传成功"),
    NO_LOGIN("023", "未登陆"),
    ILLEGAL_ARGUMENT("024", "参数不合法"),
    ERROR_ID_CODE("025", "验证码不正确");
    private String code;
    private String msg;
}
